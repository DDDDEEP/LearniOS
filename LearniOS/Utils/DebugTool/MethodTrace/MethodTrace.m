...
static __attribute__((constructor)) void entry(){
    NSString* configFiledath = [[NSBundle mainBundle] pathForResource:@"MethodTraceConfig" ofType:@"plist"];
    if(configFiledath == nil){
        NSLog(@"MethodTraceConfig.plist file is not exits!!!");
        return;
    }
    NSMutableDictionary *configItem = [NSMutableDictionary dictionaryWithContentsOfFile:configFiledath];
